...
Examples
    ...
    Create leads and lags
        ...
        . recode rel (2001=-5) (2002=-4) (2003=-3) (2004=-2) (2005=-1) (2006=0) (2007=1) (2008=2) (2009=3) (2010=4)
        . tab rel, gen(rel_)
        . rename rel_1 pre5
        . rename rel_2 pre4
        . rename rel_3 pre3
    ...
    Run the stacked event study
        . stackedev outcome pre5 pre4 pre3 pre2 pre1 post0 post1 post2 post3 ref, cohort(treat_year) time(year) never_treat(no_treat) unit_fe(state) clust_unit(state) covariates(cov)
...
Attribution
    ...
    Bleiberg, J. 2021.  stackedev: stacked event student.  https://github.com/joshbleiberg/stackedev.
